...
​		市值管理团队的存在的价值和目的到底是什么？货币之所以值钱，是因为被大众认可，具有流通性，股票亦是如此，股票如果想要具备价值就一定需要流通性。假设一幅画涨价了，但是没有人愿意买，那这个价格有意义嘛？没有任何意义，因为不具备流通性。问题来了，谁来维护股票的流通性呢？就是市值管理团队。很多时候公司的并购，反并购，市场资本运作等等都需要市值团队的配合。所以市值管理团队的存在是合理的，目的是维护流通性和配合相关资本运作。
...
​	小盘股：在底部成交量很高，说明对手盘能获取到筹码，看空
​	大盘股：在底部有成交，价值被发现，因为大盘股是资产，看多
...
好公司：公司基本面没问题（不用行业有多好，至少经营没有问题，确保相对安全）
好价格：股价在低位（确保相对安全）
好资金：有主力资金运作（在底部不一定涨，在高位不一定跌，所以要有筹码运作来提高确定性！）
好风向：主力有出货条件（这个只有等,题材消息只是触发器，**股价上涨的本质是利益驱动**）
好K 线：K线攻击模式（时间效率：技术面上去减少持股时间周期）
...
​		大宗逻辑：大股东减持；底部主力拿筹码进行代减持；机构过桥代持等
​		K线平台逻辑：支撑位，压力位
​		对冲逻辑：操作层面的
​		波段逻辑：目前中国a股只能做多赚钱，所以每年必有波段来维持团队经营。低位横盘业绩股。
​		垃圾票逻辑：主力很难出货，只能拉。			
​		短线1：短期拉了一倍说明货多，且资金已经投入。1-2W新高后再搞:说明出货失败或者有更多的想法，要继续拉。特别是垃圾票。
​		短线2：2年&200亿&融资飙升近20%,涨幅在65%以下,散户没有充足的空间融资买入,只有主力可以!(底部融资余额飙升!顶部融券余额飙升!)
​				融资融券可以大概率判断多空双发的态度,短线操作,参考300339
...
​	4.无效波段：股票每天都可以交易，有的行情看不懂的，或者是无效的:比如箱体平台等。不到操作节点不用动手，主力需要波动空间。
​	5.降低交易频次：越是高频交易，越接近零和博弈。频次越高，赌性越高。
​	6.少盯盘：不会因为盯盘而改变股价走势，只会因为盯盘改变心态，改掉习惯。
​	7.正视炒股：正视炒股背后的游戏规则，清楚知道炒股风险，丢掉幻想，净化炒股环境等。
...
​		不通过二级市场的一种买卖行为，没有平台进行买卖报价，买卖双方通过协议约定直接成交，通过后台直接话真股票份额。大宗交易成交额和成交量是公开的，但是这些信息不一定真实。把二级市场买卖股票行为当作零售的话，那么大宗交易就等于批发，既然是批发，那自然就比零售价格低了。
​	大宗折价：大宗交易这家是常规情况。如果成交金额不大，但折价很大，多半是诱空。
​	大宗溢价：比二级市场还贵，说明报价不真实。溢价成交一般是诱多。

​	**金额/筹码：**越大越好，拿了很多货。
​	**价格：**价格有返点，所以公开的价格不准确，根据基本面流动性等估算，一般在10-20%区间，猜透主力成本后 ，同步建仓。
​	**属性：**是否6个月锁定期问题

## 定向增发

​		定增是上市公司再募资行为，参与定增的机构把钱给上市公司，上市公司给这些机构股票。逻辑：钱给了上市公司，上市给了股票，那股票最后给谁？给二级市场散户！这些就需要两个前置条件：1.价格，2.成交量。否则就不能变现出来。如果参与增发的机构没有走，或者被套，这个时候进去，安全边际较高。天塌下来有个高的顶着。
...
# 9点谏言
​	1.不要觉得你比别人聪明，你获胜的方法就是找懂方向，坚持下去。
​	2.如果你的利益没有受到致命打击，请不要放手一搏。
​	3.频繁的操作会让你的内心无法平静，这会导致错误不断。
​	4.永远不要让你的收益和欲望相关联，因为它将让你无法逃离贪婪和恐惧的怪圈。
​	5.当你的心在针扎时，说明你的系统将无法正常运作，这时最好的方法是让它休息一下。
​	6.不要把赚钱的开心和亏钱的伤心成为影响你决策的因素。
​	7.止损的目的不是为了减少损失，而是确定方向是否正确。
​	8.趋势来临时，拿住是最好的投资策略，顺势而为。
​	9.放长线钓大鱼。
