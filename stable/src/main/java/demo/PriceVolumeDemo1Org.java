 ...
 */
public class PriceVolumeDemo1Org extends ApplicationFrame {
	 ...
	 */
	public PriceVolumeDemo1Org(String title) {
...
//		ServletUtilities
	...
	private static JFreeChart createChart() {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart(title, "Date", "Price", priceData, true, true, false);
...
//        );
	...
	public static void main(String[] args) {
		...
		PriceVolumeDemo1Org demo = new PriceVolumeDemo1Org("Price Volume Chart Demo");
		demo.pack();
