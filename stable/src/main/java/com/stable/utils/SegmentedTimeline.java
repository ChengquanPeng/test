...
public class SegmentedTimeline implements Timeline, Cloneable, Serializable {
	 ...
	 *
	 * @deprecated As of 1.0.7. This field doesn't take into account changes to the
	 *             default time zone.
	 */
	 ...
	 * equal size.
	 *
	 * @deprecated As of 1.0.7. This field is initialised based on the default time
	 *             zone, and doesn't take into account subsequent changes to the
	 *             default.
	 */
	 ...
	 *
	 * @deprecated As of 1.0.7. When the default time zone is required, just call
	 ...
	 *                         used to compute the included and excluded segments of
	 *                         the timeline.
	...
	/**
	 * Returns the milliseconds for midnight of the first Monday after 1-Jan-1900,
	 ...
	 * <P>
	 * The <code>startTime of the resulting timeline will be midnight of the first
	 ...
	 * startTime of the baseTimeline. This will correspond to 9:00 AM of the first
	 * Monday after 1/1/1900.
	 *
	 * @return A fully initialized SegmentedTimeline.
	 */
...
//               }
	...
	/**
	 * Returns <code>true if a range of values are contained in the timeline. This
	 * is implemented verifying that all segments are in the range.
	 *
	 ...
	 * a Segment that contains <code>index + segmentSize*m will be returned for the
	 * smallest <code>m possible.
	 *
	 ...
	 * the baseTimeline), a Segment that contains <code>date + segmentSize*m will be
	 * returned for the smallest <code>m possible.
	 *
	 ...
	 *
	 * @return <code>true if both objects are equal or both <code>null, false
	 *         otherwise.
	 */
	 ...
	 *         otherwise, <tt>(-(insertion point) - 1). The <i>insertion point is
	 *         defined as the point at which the segment would be inserted into the
	 *         list: the index of the first element greater than the key, or
	 *         <tt>list.size(), if all elements in the list are less than the
	 *         specified segment. Note that this guarantees that the return value
	...
	public class Segment implements Comparable, Cloneable, Serializable {
		...
		/**
		 * Returns <code>true if this segment is wholly before another segment.
		 *
		...
		/**
		 * Tests an object (usually another <code>Segment) for equality with this
		 * segment.
		 *
		...
		/**
		 * Returns a copy of ourselves or <code>null if there was an exception during
		 * cloning.
		 *
